...
const AboutUs = () => {
  return (
    <section
      id='about-us'
      className='flex flex-col lg:flex-row gap-2 w-full max-container p-4'
    >
      {/* Left side with grid of images */}
      <div className='flex-1 grid grid-cols-2 gap-4'>
        <div className='bg-sky-600 p-8 rounded-lg flex items-center justify-center'>
          <h3 className='text-white text-2xl font-bold'>ABOUT US</h3>
        </div>
      ...
      <div className='flex-1 flex flex-col justify-start lg:pl-8 max-lg:-mt-32'>
